        ...
        <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
          <Form>
            <div className="flex flex-col gap-5 opacity-100">
              ...
              <h2 className="text-3xl">{loginTitle}</h2>
              <Field
                type="email"
                name="email"
              ...
              <Button buttonTitle={loginTitle} width="100%" />
              <Link href={'/signup'} className="underline underline-offset-2 text-gray-300">
                {signupTitle}
              </Link>
            </div>
          </Form>
