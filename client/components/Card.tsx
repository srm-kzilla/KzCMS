...
const Card = ({ cardProps }: { cardProps: CardPropsType }) => {
  ...
  return (
    <div className="m-5 flex flex-col w-96 p-10 rounded-3xl bg-[121212] shadow-[inset_-20px_-12px_60px_#58acf525] hover:shadow-[inset_-20px_-12px_60px_#58acf530]">
      <Link href={cardProps.websiteUrl} className="text-3xl font-bold flex gap-2">
        {cardProps.title}
